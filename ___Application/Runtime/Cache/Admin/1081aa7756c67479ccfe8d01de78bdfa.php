            ...
            <div class="wrap-content container" id="container">
                ...
                <section id="page-title">
                    <div class="row">
                        <div class="col-sm-8">
                            ...
                            <span class="mainDescription">&nbsp;&nbsp;代理列表 </span>
                        </div>
                        <nav id="cl-effect-10" class="links cl-effect-10">
                            <a data-hover="新增" href="<?php echo U('admin/agent/agent_edit');?>"><span>新增</span></a>
                            ...
                            <form role="form" class="form-inline">
                                <div class="panel-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="member_name" value="<?php echo ($_GET["member_name"]); ?>"
                                               id="member_name"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="member_card" value="<?php echo ($_GET["member_card"]); ?>"
                                               id="member_card"
                                               placeholder="会员号" class="form-control">
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="status" name="status">
                                            ...
                                            <option value="0"
                                            <?php if($_GET['status'] == 0): ?>selected<?php endif; ?>
                                            >无效</option>
                                            <option value="1"
                ...
                <table class="table table-hover" id="sample-table-1">
                    ...
                    <tr>
                        ...
                        <th class="center">代理区域</th>
                        <th class="center">返点比例</th>
                    ...
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            <td class="center">#</td>
                            <td class="center"><?php echo ($vo["member_name"]); ?></td>
                            <td class="center"><?php echo ($vo["member_card"]); ?></td>
                            <td class="center"><?php echo ($vo["mobile"]); ?></td>
                            <td class="center"><?php echo ($vo["agent_region"]); ?></td>
                            <td class="center"><?php echo ($vo['rate']*100); ?>%</td>
                            <td class="center"><?php echo ($vo['status']?'有效':'无效'); ?></td>
                            <td class="center">
                                <a href="<?php echo U('admin/agent/agent_edit',array('id'=>$vo['id']));?>"
                                   class="btn btn-transparent btn-xs" tooltip="Edit" tooltip-placement="top"
                                   data-toggle="tooltip" data-original-title="编辑">
                                    <i class="fa fa-pencil"></i></a>
                                <a href="<?php echo U('admin/agent/agent_del',array('id'=>$vo['id']));?>"
                                   class="btn btn-transparent btn-xs" tooltip="Edit" tooltip-placement="top"
                                   data-toggle="tooltip" onclick="return confirm('确取删除该代理？')"
