...
<table class="table table-hover" id="sample-table-1">
				<thead>
					<tr>
						...
						<th class="center">货款总金额</th>
						<th class="center">订单返利金额</th>
						<th>订单利润</th>
						<th></th>
					</tr>
				</thead>
      ...
      <?php if(is_array($list['list'])): $key = 0; $__LIST__ = $list['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?><tr>
						<td class="center"><?php echo ($vo["member_card"]); ?><i/></td>
						<td class="center"><?php echo ($vo["consignee"]); ?><i/></td>
						<td class="center"><?php echo ($vo["order_amount"]); ?><i/></td>
						<td class="center"><?php echo ($vo["order_rebate"]); ?></td>
						<td> <?php echo ($vo['order_amount'] - $vo['order_rebate']); ?></td>
						<td>
								<a href="<?php echo U("Admin/goodsorder/Order_detail",array('id'=>$vo['order_id']));?>" class="btn btn-transparent btn-xs"  tooltip="Edit"  tooltip-placement="top" data-toggle="tooltip" data-original-title="查看"><i class="fa fa-file-text-o"></i></a>
						</td>											
