        ...
        <div class="main-content">
            <div class="wrap-content container" id="container">
                ...
                <section id="page-title">
                    <div class="row">
                        ...
                        <nav id="cl-effect-10" class="links cl-effect-10">
                            <a data-hover="新增" href="<?php echo U('admin/goodstype/type_edit');?>"><span>新增</span></a>
                        </nav>
                    </div>
                </section>
                <!-- end: PAGE TITLE -->
                        ...
                        <div class="panel panel-white">
                            ...
                            <form role="form" class="form-inline">
                                <div class="panel-body">
                                    <div class="form-group">
                                        <input type="text" name="cat_name" id="cat_name" value="<?php echo ($_GET["cat_name"]); ?>" placeholder="类型名称" class="form-control">
                                    </div>
                                    &nbsp;
                ...
                <table class="table table-hover" id="sample-table-1">
                    ...
                    <tbody>
                    <?php if(is_array($typeList)): $i = 0; $__LIST__ = $typeList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                            <td>#</td>
                            <td><?php echo ($v["cat_name"]); ?></td>
                            <td><?php echo ($v["attr_group"]); ?></td>
                            <td><?php echo ($v['enabled']?"可用":"不可用"); ?></td>
                            <td>
                                <a href="<?php echo U("Admin/goodstype/attrList",array('cat_id'=>$v['cat_id']));?>" class="btn btn-transparent btn-xs"
                                tooltip="Edit" tooltip-placement="top" data-toggle="tooltip" data-original-title="属性列表"><i
                                    class="fa fa-th-list"></i></a>
                                <a href="<?php echo U("Admin/goodstype/type_edit",array('id'=>$v['cat_id']));?>" class="btn
                                ...
                                <a href="<?php echo U("Admin/goodstype/type_del",array('id'=>$v['cat_id']));?>" class="btn
                                btn-transparent btn-xs tooltips" tooltip-placement="top" tooltip="Remove"
                                onclick="return confirm('确定删除该属性？')" tooltip-placement="top" data-toggle="tooltip"
                                data-original-title="删除"><i class="fa fa-minus-square"></i></a>
                            </td>
                        </tr><?php endforeach; endif; else: echo "" ;endif; ?>
                    </tbody>
                </table>
    </div>
                <?php if(empty($typeList)): ?>暂无数据<?php endif; ?>
