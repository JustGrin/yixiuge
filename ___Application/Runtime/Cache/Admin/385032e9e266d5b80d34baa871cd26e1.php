            ...
            <div class="wrap-content container" id="container">
                            ...
                            <form role="form" class="form-inline">
                                <div class="panel-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="member_card" value="<?php echo ($_GET["member_card"]); ?>" id="member_card" placeholder="会员名称" class="form-control">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="status" name="status">
                                            <option value="all" <?php if($_GET['status'] =='all'): ?>selected<?php endif; ?>>全部状态</option>
                                            <?php if(is_array($status_arr)): $i = 0; $__LIST__ = $status_arr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($key > 0): ?><option value="<?php echo ($key); ?>" <?php if(($_GET['status'] == $key)): ?>selected<?php endif; ?>><?php echo ($vo); ?></option>
                                                    <?php else: ?>
                                                    <option value="<?php echo ($key); ?>" <?php if((empty($_GET['status']) && $_GET['status'] == $key)): ?>selected<?php endif; ?>><?php echo ($vo); ?></option><?php endif; endforeach; endif; else: echo "" ;endif; ?>
                ...
                <table class="table table-hover" id="sample-table-1">
                    ...
                    <?php if(is_array($list['list'])): $key = 0; $__LIST__ = $list['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?><tr >
                            ...
                            <td class="hidden-xs"><?php echo ($vo["order_sn"]); ?>
                            </td>
                            <td>
                                <?php echo ($vo["order_amount"]); ?>(<?php echo ($vo["goods_price"]); ?>)
                            </td>
                            <td class="hidden-xs"><?php echo ($vo["refund_sn"]); ?>
                            </td>
                            <td> <?php echo ($vo["integral"]); ?></td>
                            <td> <?php echo ($vo["balance"]); ?></td>
                            <td> <?php echo ($vo["wx_refund"]); ?></td>
                            <td style="color: #ff0000!important"> <?php echo ($vo["total"]); ?></td>
                            <td>
                            ...
                            <td>
                                ...
                                <?php if($vo['status'] == 0): ?>退款申请中
                                    <?php elseif($vo['status'] == 1): ?>
                                    已退款
                                    <?php elseif($vo['status'] == 2): ?>
                                    已拒绝(<?php echo ($vo["remarks"]); ?>)<?php endif; ?>

                            </td>

                            <td class="center">
                                <div class="visible-md visible-lg hidden-sm hidden-xs">
                                    <a href="<?php echo U("Admin/Orderinfo/refund_apply_detail",array('id'=>$vo['id'],'open'=>'check'));?>" class="btn btn-transparent btn-xs" tooltip-placement="top" data-toggle="tooltip" data-original-title="查看"><i class="fa fa-file-text-o"></i></a>

                                    <?php if($vo['status'] == 0): ?><a href="<?php echo U("Admin/Orderinfo/refund_apply_detail",array('id'=>$vo['id'],'open'=>'handle'));?>" class="btn btn-transparent btn-xs" tooltip-placement="top" data-toggle="tooltip" data-original-title="财务审核"><i class="fa fa-list-alt"></i></a><?php endif; ?>

                                    <!-- <a href="<?php echo U("Admin/Ad/ad_type_del",array('id'=>$vo['id']));?>" class="btn btn-transparent btn-xs tooltips" tooltip-placement="top" data-toggle="tooltip" data-original-title="删除" onclick="return confirm('确定删除该数据？')"><i class="fa fa-times fa fa-white"></i></a> -->
