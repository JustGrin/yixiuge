				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">网站常规设置列表</h1>
									<span class="mainDescription"></span>
								</div>
							<!-- 	<nav id="cl-effect-10" class="links cl-effect-10">
								<a data-hover="新增" href="<?php echo U('admin/system/sys_param_edit');?>"><span>新增</span></a>
							</nav> -->
								<!-- <ol class="breadcrumb">
									<li>
										<span>Pages</span>
		...
		<div class="panel-body">
			...
			<!-- 	<div class="form-group">
				  ...
				  <label for="account" class="sr-only">
					...
					<input type="text" name="param_code" value="<?php echo ($_GET["param_code"]); ?>" id="param_code" placeholder="字典参数code" class="form-control">
				...
				<div class="form-group">
					...
					<input type="text" placeholder="字典参数名称" value="<?php echo ($_GET["param_name"]); ?>"  name="param_name" id="param_name" class="form-control">
				</div>
...
<table class="table table-hover" id="sample-table-1">
				<thead>
					<tr>
						<!-- <th class="center">字典参数code</th> -->
						<th>名称</th>
						<th class="hidden-xs">参数值</th>
						<th>参数描述</th>
						<th></th>
					</tr>
				</thead>
      ...
      <?php if(is_array($list['list'])): $key = 0; $__LIST__ = $list['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?><tr>
						<!-- <td class="center"><?php echo ($vo["param_code"]); ?><i/></td> -->
						<td class="hidden-xs"><?php echo ($vo["param_name"]); ?></td>
						<td><?php echo (mbubstr_html($vo["param_value"],0,10)); ?></td>
						<td>
						 <?php echo (mbubstr_html($vo["param_desc"],0,15)); ?>
						</td>
					
						<td class="center">
						<div class="visible-md visible-lg hidden-sm hidden-xs">
							     <a href="<?php echo U("Admin/System/sys_param_edit",array('id'=>$vo['id']));?>" class="btn btn-transparent btn-xs"  tooltip="Edit"  tooltip-placement="top" data-toggle="tooltip" data-original-title="编辑"><i class="fa fa-pencil"></i></a>
