				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">广告位置/类型</h1>
								</div>
								<nav id="cl-effect-10" class="links cl-effect-10">
									<a data-hover="新增" href="<?php echo U('admin/Ad/ad_type_edit');?>"><span>新增</span></a>
								</nav>
								<!-- <ol class="breadcrumb">
									<li>
										<span>Pages</span>
	...
	.class_hidden{display:none;}
						...
						<div class="row">
							<div class="col-lg-12 col-md-12 margin-top-20" >
								<div class="panel panel-white">
									...
									<form role="success" class="form-inline">
										<div class="panel-body">
											...
											<div class="form-group">
												...
												广告标题:
												<input type="text" name="title" value="<?php echo ($_GET["title"]); ?>" id="title" placeholder="广告标题" class="form-control">
											</div>
											<!--<div class="form-group">
												...
												<p class="input-group input-append datepicker date">
													<input type="text" class="form-control" name="start_time" value="<?php echo ($_GET['start_time']); ?>"/>
												...
												-
												<p class="input-group input-append datepicker date">
													   <input type="text" class="form-control" name="end_time" value="<?php echo ($_GET['end_time']); ?>"/>
			                                      <span class="input-group-btn">
				                                   <button type="button" class="btn btn-default">
													   <i class="glyphicon glyphicon-calendar"></i>
												   </button> </span>
      ...
      <?php if(is_array($list['list'])): $key = 0; $__LIST__ = $list['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?><tr >
						...
						<div class="visible-md visible-lg hidden-sm hidden-xs">
							...
							<a href="<?php echo U("Admin/Ad/ad_list",array('id'=>$vo['id']));?>" class="btn btn-transparent btn-xs" tooltip-placement="top" data-toggle="tooltip" data-original-title="广告设置"><i class="fa fa-list-alt"></i></a>


							<a href="<?php echo U("Admin/Ad/ad_type_edit",array('id'=>$vo['id']));?>" class="btn btn-transparent btn-xs" tooltip-placement="top" data-toggle="tooltip" data-original-title="编辑"><i class="fa fa-pencil"></i></a>
