				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8 ">
									 <h1 class="mainTitle">留言管理列表</h1>
									<span class="mainDescription">&nbsp;&nbsp;留言管理 </span>
								</div>
	...
	<form role="form" class="form-inline">	
		<div class="panel-body">
				...
				<div class="form-group">
					  ...
					  昵称:
						<input type="text" name="title" value="<?php echo ($_GET["title"]); ?>" id="member_name" placeholder="昵称" class="form-control">
				</div>
				 <div class="form-group">
					  <label for="account" class="sr-only">
						电话
					  ...
					  电话:
						<input type="text" name="phone" value="<?php echo ($_GET["phone"]); ?>" id="phone" placeholder="电话" class="form-control">
				</div> 
				 <div class="form-group">
					<label for="member_type" class="sr-only">
						状态
					</label>
					状态：
...
<table class="table table-hover" id="sample-table-1">
      ...
      <?php if(is_array($list['list'])): $key = 0; $__LIST__ = $list['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?><tr  >
						...
						<td ><?php echo (mbubstr_html($vo["message"],0,36)); ?></td>
						<td><?php echo (date("Y-m-d",$vo["add_time"])); ?>	</td>
						<td><?php echo ($status[$vo['status']]); ?></td>
						<td><?php echo (mbubstr_html($vo["remark"],0,36)); ?></td>
						<td class="center">
						<div class="visible-md visible-lg hidden-sm hidden-xs">
                           	<a href="<?php echo U("Admin/Message/message_detail",array('id'=>$vo['id']));?>" class="btn btn-transparent btn-xs"  tooltip="Edit"  tooltip-placement="top" data-toggle="tooltip" data-original-title="查看"><i class="fa fa-file-text-o"></i></a>
