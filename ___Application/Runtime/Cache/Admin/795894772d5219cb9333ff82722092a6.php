				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">部门列表</h1>
									<span class="mainDescription">部门管理页面 </span>
								</div>
								<nav id="cl-effect-10" class="links cl-effect-10">
									<a data-hover="新增" href="<?php echo U('admin/Personnel/personnel_edit');?>"><span>新增</span></a>
								</nav>
								<!-- <ol class="breadcrumb">
									<li>
										<span>Pages</span>
...
<table class="table table-hover" id="sample-table-1">
				...
				<tbody>
      <?php if(is_array($menulist)): $key = 0; $__LIST__ = $menulist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?><tr class="menu_p" data="<?php echo ($vo["id"]); ?>" data-type="0">
						<td class="center"></td>
						<td> <?php echo ($vo["p_name"]); ?>
						  <?php if((!empty($vo['tree']))): ?><i class="fa fa-angle-down  angle_down_<?php echo ($vo["id"]); ?>"></i><i class="fa fa-angle-up angle_up_<?php echo ($vo["id"]); ?> class_hidden"></i><?php endif; ?>
						</td>
						<td class="hidden-xs"><?php echo ($vo["p_des"]); ?>
						</td>
						<td>
						...
						<div class="visible-md visible-lg hidden-sm hidden-xs">
							<a href="<?php echo U("Admin/Personnel/personnel_edit",array('id'=>$vo['id']));?>" class="btn btn-transparent btn-xs" tooltip-placement="top" data-toggle="tooltip" data-original-title="编辑"><i class="fa fa-pencil"></i></a>
							
							<a href="<?php echo U("Admin/Personnel/personnel_del",array('id'=>$vo['id']));?>" class="btn btn-transparent btn-xs tooltips" tooltip-placement="top" data-toggle="tooltip" data-original-title="删除" onclick="return confirm('确定删除该数据？')"><i class="fa fa-times fa fa-white"></i></a>
						</div>
						</td>
					</tr>
					<?php if((!empty($vo['tree']))): if(is_array($vo['tree'])): $i = 0; $__LIST__ = $vo['tree'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$voo): $mod = ($i % 2 );++$i;?><tr class="class_hidden menu_p_c menu_p_<?php echo ($vo["id"]); ?>">
						<td class="center"></td>
						<td >┗━<?php echo ($voo["p_name"]); ?></td>
						<td class="hidden-xs"> <?php echo ($voo["p_des"]); ?></td>
						<td>
						<?php echo ($voo['status']?'有效':'无效'); ?>	
						</td>
						
						<td class="center">
						<div class="visible-md visible-lg hidden-sm hidden-xs">
							<a href="<?php echo U("Admin/Personnel/personnel_edit",array('id'=>$voo['id']));?>" class="btn btn-transparent btn-xs" tooltip-placement="top" data-toggle="tooltip" data-original-title="编辑"><i class="fa fa-pencil"></i></a>
							
							<a href="<?php echo U("Admin/Personnel/personnel_del",array('id'=>$voo['id']));?>" class="btn btn-transparent btn-xs tooltips" tooltip-placement="top" data-toggle="tooltip" data-original-title="删除"><i class="fa fa-times fa fa-white" onclick="return confirm('确定删除该数据？')"></i></a>
						</div>
						</td>
