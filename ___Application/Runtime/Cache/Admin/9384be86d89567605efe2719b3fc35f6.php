            ...
            <div class="wrap-content container" id="container">
                ...
                <table class="table table-hover" id="sample-table-1">
                    ...
                    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td><?php echo ($val["member_card"]); ?></td>
                            <td><?php echo ($val["goods_name"]); ?></td>
                            <td><?php echo ($val["consignee"]); ?></td>
                            <!--<td><?php echo ($val["address"]); ?></td>-->
                            <td><?php echo ($val["mobile"]); ?></td>
                            <td><?php echo ($val['status']?'已发货':'待发货'); ?></td>
                            <td><?php echo (date('Y-m-d',$val['add_time'])); ?></td>
                            <td class="center">
                                <a href="<?php echo U('admin/Usernotice/activity_receive_detail',array('id'=>$val['activity_id']));?>" class="btn btn-transparent btn-xs nondelivery" tooltip="Edit" tooltip-placement="top"
                                   data-toggle="tooltip" data-original-title="查看"><i class="fa fa-file-text-o"></i></a>
                            </td>
