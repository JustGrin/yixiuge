						...
						<section id="page-title">
							<div class="row">
								...
								<nav id="cl-effect-10" class="links cl-effect-10">
									<a data-hover="新增" href="<?php echo U('admin/system/manager_edit');?>"><span>新增</span></a>
								</nav>
								<!-- <ol class="breadcrumb">
									<li>
										<span>Pages</span>
	...
	<form role="form" class="form-inline">	
		<div class="panel-body">
				...
				<div class="form-group">
					  ...
					  名称:
						<input type="text" name="account" value="<?php echo ($_GET['account']); ?>" id="account" placeholder="帐号" class="form-control">
				...
				<div class="form-group">
					...
					名称:
					<input type="text" placeholder="名称" value="<?php echo ($_GET["name"]); ?>"  name="name" id="name" class="form-control">
				</div>
				<div class="form-group">
					...
					电话：
					<input type="text" name="mobile" value="<?php echo ($_GET["mobile"]); ?>" placeholder="电话" id="mobile" class="form-control">
				</div>
		...
		<div class="panel-body">
			<?php if($_SESSION['topadmin'] > 0): ?><div class="form-group">
					...
					<select class="form-control" id="type" name="type">
						<option value="all" <?php if($_GET['type'] =='all'): ?>selected<?php endif; ?>>全部</option>
						<option value="1" <?php if($_GET['type'] ==1): ?>selected<?php endif; ?>>管理员</option>
						<option value="0" <?php if($_GET['type'] ==='0'): ?>selected<?php endif; ?>>商家</option>
					</select>
				</div><?php endif; ?>
			 <div class="form-group">
					<label for="type" class="sr-only">
					...
					<select class="form-control" id="status" name="status">
						<option value="all" <?php if($_GET['status'] =='all'): ?>selected<?php endif; ?>>全部</option>
						<option value="1" <?php if($_GET['status'] ==1): ?>selected<?php endif; ?>>正常</option>
						<option value="0" <?php if($_GET['status'] ==='0'): ?>selected<?php endif; ?>>冻结</option>
					</select>
				</div>	
...
<table class="table table-hover" id="sample-table-1">
      ...
      <?php if(is_array($list['list'])): $key = 0; $__LIST__ = $list['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?><tr>
						<td class="center"><?php echo ($vo["account"]); ?><i/></td>
						<td class="hidden-xs"><?php echo ($vo["name"]); ?></td>
						<td> <?php echo ($vo["mobile"]); ?></td>
						<td>
						<?php echo ($vo['type']?'管理员':'商家'); ?>	
						</td>
						<td>
						<?php echo ($vo['status']?'正常':'冻结'); ?>	
						</td>
						<td class="center">
						<div class="visible-md visible-lg hidden-sm hidden-xs">
							<?php if(($_SESSION['topadmin']==1)): ?>
								  
								  <?php if($vo['shop_count'] < 1): ?><a href="<?php echo U("admin/shop/shop_edit",array('shop_id'=>$vo['fid']));?>" class="btn btn-transparent btn-xs"  tooltip="Edit"  tooltip-placement="top" data-toggle="tooltip" data-original-title="添加商家信息"><i class="fa fa-list-alt"></i></a><?php endif; ?>	
									<a href="<?php echo U("Admin/System/manager_edit",array('id'=>$vo['id']));?>" class="btn btn-transparent btn-xs"  tooltip="Edit"  tooltip-placement="top" data-toggle="tooltip" data-original-title="编辑"><i class="fa fa-pencil"></i></a>
									<?php if($vo['id']!=$_SESSION['auid']): if($vo["status"] == 1): ?><a href="<?php echo U("Admin/System/manage_del",array('id'=>$vo['id']));?>" class="btn btn-transparent btn-xs tooltips" tooltip-placement="top" tooltip="Remove" onclick="return confirm('确定冻结该用户？')"  tooltip-placement="top" data-toggle="tooltip" data-original-title="冻结"><i class="fa fa-minus-square"></i></a>
					                    <?php else: ?>
					                     <a href="<?php echo U("Admin/System/manage_del",array('id'=>$vo['id']));?>" class="btn btn-transparent btn-xs tooltips" tooltip-placement="top" tooltip="Remove" onclick="return confirm('确定解冻该用户？')" tooltip-placement="top" data-toggle="tooltip" data-original-title="解冻"><i class="fa fa-check-square"></i></a><?php endif; endif; ?>
							<?php elseif(($_SESSION['topadmin']==2 )): ?>
							
								<?php if(($_SESSION['auid']==$vo['id'] || $vo['type']==0)): ?><a href="<?php echo U("Admin/System/manager_edit",array('id'=>$vo['id']));?>" class="btn btn-transparent btn-xs" tooltip="Edit"  tooltip-placement="top" data-toggle="tooltip" data-original-title="编辑"><i class="fa fa-pencil"></i></a><?php endif; ?>
	                              <?php if($vo['type']==0): if($vo["status"] == 1): ?><a href="<?php echo U("Admin/System/manage_del",array('id'=>$vo['id']));?>" class="btn btn-transparent btn-xs tooltips"   onclick="return confirm('确定冻结该用户？')"><i class="fa fa-minus-square" tooltip-placement="top" data-toggle="tooltip" data-original-title="冻结"></i></a>
					                    <?php else: ?>
					                     <a href="<?php echo U("Admin/System/manage_del",array('id'=>$vo['id']));?>" class="btn btn-transparent btn-xs tooltips" tooltip-placement="top" data-toggle="tooltip" data-original-title="解冻" onclick="return confirm('确定解冻该用户？')"><i class="fa fa-check-square"></i></a><?php endif; endif; ?>
                            <?php else: ?>
                            
	                            <?php if(($_SESSION['auid']==$vo['id'] || $vo['fid']==$_SESSION['auid'])): ?><a href="<?php echo U("Admin/System/manager_edit",array('id'=>$vo['id']));?>" class="btn btn-transparent btn-xs"  tooltip-placement="top" data-toggle="tooltip" data-original-title="编辑"><i class="fa fa-pencil"></i></a><?php endif; ?>
	                            
	                            <?php if($vo['fid']==$_SESSION['auid'] && $_SESSION['auid']!=$vo['id']): if($vo["status"] == 1): ?><a href="<?php echo U("Admin/System/manage_del",array('id'=>$vo['id']));?>" class="btn btn-transparent btn-xs tooltips"  tooltip-placement="top" data-toggle="tooltip" data-original-title="冻结" onclick="return confirm('确定冻结该用户？')"><i class="fa fa-minus-square"></i></a>
					                    <?php else: ?>
					                     <a href="<?php echo U("Admin/System/manage_del",array('id'=>$vo['id']));?>" class="btn btn-transparent btn-xs tooltips"  tooltip-placement="top" data-toggle="tooltip" data-original-title="解冻" onclick="return confirm('确定解冻该用户？')"><i class="fa fa-check-square"></i></a><?php endif; endif; endif; ?>
