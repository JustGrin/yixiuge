				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">提现银行</h1>
									<span class="mainDescription">银行列表</span>
								</div>
							</div>
						</section>
						<!-- end: PAGE TITLE -->
...
<table class="table table-striped table-hover" id="sample-table-2">
      ...
      <?php if(is_array($list)): $key = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?><tr>
						...
						<td class="hidden-xs"><?php echo ($vo["blank_name"]); ?></td>
						...
						<div class="visible-md visible-lg hidden-sm hidden-xs">
							...
							<a href="<?php echo U("Admin/Cashapply/blank_edit",array('id'=>$vo['blank_id']));?>" class="btn btn-transparent btn-xs" tooltip-placement="top" data-toggle="tooltip" data-original-title="编辑"><i class="fa fa-pencil"></i></a>

							<a href="<?php echo U("Admin/Cashapply/blank_del",array('id'=>$vo['blank_id']));?>" class="btn btn-transparent btn-xs tooltips" tooltip-placement="top" data-toggle="tooltip" data-original-title="删除"><i class="fa fa-times fa fa-white" onclick="return confirm('确定删除该数据？')"></i></a>
...
<?php if(empty($list)): ?>暂无数据<?php endif; ?>
