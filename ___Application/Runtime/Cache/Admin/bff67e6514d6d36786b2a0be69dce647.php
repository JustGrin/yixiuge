                ...
                <section id="page-title">
                    <div class="row">
                        ...
                        <nav id="cl-effect-10" class="links cl-effect-10">
                            <a data-hover="新增" href="<?php echo U('admin/category/category_edit');?>"><span>新增</span></a>
                        </nav>
                        <!-- <ol class="breadcrumb">
                            <li>
                                <span>Pages</span>
       ...
       <div class="panel panel-white">
        ...
        <form role="form" class="form-inline">
              <div class="panel-body">
                     <div class="form-group">
                        <input type="text" name="cat_name" id="cat_name" value="<?php echo ($_GET["cat_name"]); ?>" placeholder="分类名称" class="form-control">
                     </div>
                      <div class="form-group">
                        <input type="text" name="keywords" id="keywprds" value="<?php echo ($_GET["keywords"]); ?>" placeholder="关键字" class="form-control">
                      </div>
                       &nbsp;
                ...
                <table class="table table-hover" id="sample-table-1">
                    ...
                    <tbody>
                    <?php if(is_array($typeList)): $i = 0; $__LIST__ = $typeList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr class="menu_p" data="<?php echo ($val["cat_id"]); ?>" data-type="0">
                            <td>#</td>
                            <td calss="hidden-xs"><?php echo ($val["cat_name"]); ?>
                                <i class="fa fa-angle-down  angle_down_<?php echo ($val["cat_id"]); ?>"></i>
                                <i class="fa fa-angle-up angle_up_<?php echo ($val["cat_id"]); ?> class_hidden"></i>
                            </td>
                            <td><?php echo ($val["keywords"]); ?></td>
                            <td><?php echo ($val["cat_desc"]); ?></td>
                            <!--<td><?php echo ($val["sort_order"]); ?></td>-->
                            <!--<td><?php echo ($val["measure_unit"]); ?></td>-->
                            <td><?php echo ($val['need_check']?'是':'否'); ?></td>
                            <td><?php echo ($val['is_show']?'是':'否'); ?></td>
							<td><?php echo ($val['is_exhibition']?'是':'否'); ?></td>
                            <!--<td><?php echo ($val['show_in_nav']?'是':'否'); ?></td>-->
                            <td>
                                <a href="<?php echo U("Admin/category/category_edit",array('id'=>$val['cat_id']));?>"
                                ...
                                <a href="<?php echo U("Admin/category/category_del",array('id'=>$val['cat_id']));?>" class="btn
                        ...
                        <!-- 二级分类开始-->
                        <?php if((!empty($val['tree']))): if(is_array($val['tree'])): $i = 0; $__LIST__ = $val['tree'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$va): $mod = ($i % 2 );++$i;?><tr class="class_hidden menu_p_c menu_p_<?php echo ($val["cat_id"]); ?>" data_p_c="<?php echo ($val["cat_id"]); ?>"  data_c="<?php echo ($va["cat_id"]); ?>" data-type_c="0">
                                    <td>#</td>
                                    <td calss="hidden-xs">&nbsp;┗━<?php echo ($va["cat_name"]); ?>
                                        <i class="fa fa-angle-down angle_down_c_<?php echo ($val["cat_id"]); ?>  angle_down_c<?php echo ($va["cat_id"]); ?>"></i>
                                        <i class="fa fa-angle-up angle_up_c_<?php echo ($val["cat_id"]); ?> angle_up_c<?php echo ($va["cat_id"]); ?> class_hidden"></i>
                                    </td>
                                    <td><?php echo ($va["keywords"]); ?></td>
                                    <td><?php echo ($va["cat_desc"]); ?></td>
                                    <!--<td><?php echo ($va["sort_order"]); ?></td>-->
                                    <!--<td><?php echo ($va["measure_unit"]); ?></td>-->
                                    <td><?php echo ($va['is_show']?'是':'否'); ?></td>
									<td><?php echo ($va['is_exhibition']?'是':'否'); ?></td>
                                    <!--<td><?php echo ($va['show_in_nav']?'是':'否'); ?></td>-->
                                    <td>
                                        <a href="<?php echo U("Admin/category/category_edit",array('id'=>$va['cat_id']));?>"
                                        class="btn btn-transparent btn-xs" tooltip-placement="top" data-toggle="tooltip"
                                        data-original-title="编辑"><i class="fa fa-pencil"></i></a>
                                        <a href="<?php echo U("Admin/category/category_del",array('id'=>$va['cat_id']));?>"
                                        class="btn
                                        btn-transparent btn-xs tooltips" tooltip-placement="top" data-toggle="tooltip"
                                ...
                                <!-- 三级分类开始-->
                                <?php if((!empty($va['tree']))): if(is_array($va['tree'])): $i = 0; $__LIST__ = $va['tree'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr class="class_hidden menu_p_c_s  menu_p_c<?php echo ($va["cat_id"]); ?>">
                                            <td>#</td>
                                            <td calss="hidden-xs">&nbsp;&nbsp;&nbsp;&nbsp;┗━━<?php echo ($v["cat_name"]); ?></td>
											...
											<td><?php echo ($v['is_exhibition']?'是':'否'); ?></td>
                                            <!--<td><?php echo ($v['show_in_nav']?'是':'否'); ?></td>-->
                                            <td>
                                                <a href="<?php echo U("Admin/category/category_edit",array('id'=>$v['cat_id']));?>"
                                                class="btn btn-transparent btn-xs" tooltip-placement="top"
                                                data-toggle="tooltip"
                                                data-original-title="编辑"><i class="fa fa-pencil"></i></a>
                                                <a href="<?php echo U("Admin/category/category_del",array('id'=>$v['cat_id']));?>"
                                                class="btn
                                ...
                                <!-- 三级分类结束--><?php endforeach; endif; else: echo "" ;endif; endif; ?>
                        <!-- 二级分类结束--><?php endforeach; endif; else: echo "" ;endif; ?>
                   
                    </tbody>

                </table>
              <div class="col-md-12 pages" align="center">'暂无数据'</div>
