...
<div class="row">
	...
	<div class="form-group">
		...
		<input type="text" placeholder="填写标题" class="form-control" value="<?php echo ($id ? $data['title'] : ''); ?>" id="title" name="title">
	</div>
      <div class="form-group">
		<label class="control-label">
		...
		<select class="form-control" id="type" name="type">
			<option value="1"  <?php if($id && $data["type"] == 1): ?>selected<?php endif; ?>>公告</option>
			<option value="2"  <?php if($id && $data["type"] == 2): ?>selected<?php endif; ?>>动态</option>
   	...
   	<div class="form-group">
		...
		<div>
		<textarea id="abstrac" name="abstrac"  class=" autosize" data-autosize-on="true" style="overflow: hidden; resize: horizontal; word-wrap: break-word;  width: 100%;  height: 100px;"><?php echo ($id ? $data['abstrac'] : ''); ?></textarea>
	    </div>
	</div>
         ...
         <input type="file" name="head_photo" class="upload_input" id="head_photo" value="" style="display:none;"> 
          <div class="fileinput fileinput-new" data-provides="fileinput">
                <div class="fileinput-new thumbnail" id="show_photo">
                    <img id="head_photo_src" src="<?php echo ($id ? $data['imgpath'] : ''); ?>" alt="">
                </div>
            </div>
           点击图片上传
        </label>  
          ...
          <input type="hidden" name="imgpath" id="image_path" value="<?php echo ($id ? $data['imgpath'] : ''); ?>">
    </div>
	...
	<div class="form-group">
		...
		<div>
		<textarea id="type_2" name="content"  class=" autosize" data-autosize-on="true" style="overflow: hidden; resize: horizontal; word-wrap: break-word;  width: 100%;  height: 300px;"><?php echo ($id ? $data['content'] : ''); ?></textarea>
		 <!-- 加载编辑器的容器 -->
	    </div>
