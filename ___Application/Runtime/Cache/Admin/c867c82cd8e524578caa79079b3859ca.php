						...
						<section id="page-title">
							<div class="row">
								...
								<nav id="cl-effect-10" class="links cl-effect-10">
									<a data-hover="新增" href="<?php echo U('admin/goodstype/attrbute_edit');?>"><span>新增</span></a>
							</div>
						</section>
						<!-- end: PAGE TITLE -->
	...
	.class_hidden{display:none;}
								...
								<div class="panel panel-white">
									...
									<form role="form" class="form-inline" >
										<div class="panel-body">
											<div class="form-group">
												<input type="text" name="attr_name" id="attr_name" value="<?php echo ($_GET["attr_name"]); ?>" placeholder="属性名称" class="form-control">
											</div>
											<div class="form-group">
												<select class="form-control valid" id="dropdown" name="cat_id">
													<option value="0">-所有商品类型-</option>
													<?php if(is_array($typeList)): $i = 0; $__LIST__ = $typeList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option value="<?php echo ($v["cat_id"]); ?>" <?php if($_GET["cat_id"] == $v['cat_id']): ?>selected<?php endif; ?>><?php echo ($v["cat_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
												</select>
											</div>
				...
				<thead>
					<tr>
						...
						<th>商品类型</th>
						<th>属性值录入方式</th>
						<th width="50%">可选值列表</th>
						<th>排序</th>
						<th>操作</th>
					</tr>
				</thead>
				<tbody>
				<?php if(is_array($attrList)): $i = 0; $__LIST__ = $attrList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
						<td>#</td>
						<td><?php echo ($v["attr_name"]); ?></td>
						<td><?php echo ($v["cat_name"]); ?></td>
						<td>
							<?php if($v["attr_input_type"] == 0): ?>手工输入 <?php elseif($v["attr_input_type"] == 1): ?>选择输入 <?php else: ?> 多行文本输入<?php endif; ?>
						</td>
						<td title="<?php echo ($v["attr_values"]); ?>"><?php echo ($v["attr_values"]); ?></td>
						<td><?php echo ($v["sort_order"]); ?></td>
						<td>
							<a href="<?php echo U("Admin/goodstype/attrbute_edit",array('id'=>$v['attr_id']));?>" class="btn btn-transparent btn-xs" tooltip-placement="top" data-toggle="tooltip" data-original-title="编辑"><i class="fa fa-pencil"></i></a>
							<a href="<?php echo U("Admin/goodstype/attrbute_del",array('id'=>$v['attr_id']));?>" class="btn btn-transparent btn-xs tooltips" tooltip-placement="top" tooltip="Remove" onclick="return confirm('确定删除该属性？')"  tooltip-placement="top" data-toggle="tooltip" data-original-title="删除"><i class="fa fa-minus-square"></i></a>
						</td>
					</tr><?php endforeach; endif; else: echo "" ;endif; ?>
				</tbody>
			</table>

<?php if(empty($attrList)): ?>暂无数据<?php endif; ?>	
						<!-- end: YOUR CONTENT HERE -->
						 
 <div class="col-md-12 pages" align="center"><?php echo ($page); ?></div>
