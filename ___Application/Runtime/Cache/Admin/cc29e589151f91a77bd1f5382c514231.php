						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									...
									<span class="mainDescription">活动列表</span>
								</div>
							</div>
						</section>
						<!-- end: PAGE TITLE -->
...
<table class="table table-striped table-hover" id="sample-table-2">
      ...
      <?php if(is_array($list)): $key = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?><tr>
						...
						<td class="hidden-xs"><?php echo ($vo["activity_name"]); ?></td>
						<td >
							<?php echo ($vo["desc"]); ?>
						</td>
						<td>
						<?php echo ($vo['is_del']?'无效':'有效'); ?>
						</td>
	
						<td class="center">
						<div class="visible-md visible-lg hidden-sm hidden-xs">
							
							<a href="<?php echo U("Admin/Activity/activity_edit",array('id'=>$vo['id']));?>" class="btn btn-transparent btn-xs" tooltip-placement="top" data-toggle="tooltip" data-original-title="编辑"><i class="fa fa-pencil"></i></a>

							<a href="<?php echo U("Admin/Activity/activity_del",array('id'=>$vo['id']));?>" class="btn btn-transparent btn-xs tooltips" tooltip-placement="top" data-toggle="tooltip" data-original-title="删除"><i class="fa fa-times fa fa-white" onclick="return confirm('确定删除该数据？')"></i></a>
