            ...
            <div class="wrap-content container" id="container">
                ...
                <section id="page-title">
                    <div class="row">
                        ...
                        <nav id="cl-effect-10" class="links cl-effect-10">
                            <a data-hover="新增" href="<?php echo U('admin/Draw/draw_edit');?>"><span>新增</span></a>
                ...
                <table class="table table-hover" id="sample-table-1">
                    ...
                    <?php if(is_array($data['list'])): $i = 0; $__LIST__ = $data['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$val): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td>
                                <?php if($val['draw_type'] != 5): echo ($val["draw_value"]); ?>
                                    <?php else: ?>
                                    <a href="<?php echo U('wap/goods/goods_detail');?>?id=<?php echo ($val["draw_value"]); ?>"><?php echo ($val["goods_msg"]); ?></a><?php endif; ?>
                            </td>
                            <td><?php echo ($val["draw_chances_value"]); ?></td>
                            <td><?php echo ($val["odds"]); ?>%</td>
                            <td id="draw_status_<?php echo ($val["id"]); ?>">
                                <?php if($val["draw_status"] == 1): ?><a href="javascript:void(0)" onclick="setStatus(<?php echo ($val["draw_status"]); ?>,<?php echo ($val["id"]); ?>)"
                                    ...
                                    <?php else: ?>
                                    <a href="javascript:void(0)" onclick="setStatus(<?php echo ($val["draw_status"]); ?>,<?php echo ($val["id"]); ?>)"
                                       class="btn btn-transparent btn-xs" tooltip="Edit" tooltip-placement="top"
                                       data-toggle="tooltip" data-original-title="无效"><i class="fa fa-check-circle" style="color:#ccc;" value="1"></i></a><?php endif; ?>
                            </td>
                            <td id="is_shenghe_<?php echo ($val["id"]); ?>">
                                <?php if($val["is_shenghe"] == 1): ?><a href="javascript:void(0)" onclick="setVerify(<?php echo ($val["is_shenghe"]); ?>,<?php echo ($val["id"]); ?>)"
                                       class="btn btn-transparent btn-xs" tooltip="Edit" tooltip-placement="top"
                                       data-toggle="tooltip" data-original-title="已审核"><i class="fa fa-check-circle"></i></a>
                                    <?php else: ?>
                                    <a href="javascript:void(0)" onclick="setVerify(<?php echo ($val["is_shenghe"]); ?>,<?php echo ($val["id"]); ?>)"
                                       class="btn btn-transparent btn-xs" tooltip="Edit" tooltip-placement="top"
                                       data-toggle="tooltip" data-original-title="未审核"><i class="fa fa-check-circle" style="color:#ccc;" value="1"></i></a><?php endif; ?>
                            </td>
                            <td><?php echo (date("Y-m-d",$val["add_time"])); ?></td>
                            <td>
                                <div class="visible-md visible-lg hidden-sm hidden-xs">
                                    <a href="<?php echo U("Admin/Draw/draw_edit",array('id'=>$val['id']));?>"
                                    class="btn btn-transparent btn-xs" tooltip="Edit" tooltip-placement="top"
                                    data-toggle="tooltip" data-original-title="编辑">
                                    <i class="fa fa-pencil"></i></a>
                                    <a href="<?php echo U("Admin/Draw/draw_del",array('id'=>$val['id']));?>"
                                    class="btn btn-transparent btn-xs" tooltip="Edit" tooltip-placement="top"
                ...
                <div class="col-md-12 pages" align="center"><?php echo (($data['page'])?($data['page']):'暂无数据'); ?></div>
...
<script type="text/javascript">
    function setStatus(status,id) {
        ...
        $.ajax({
            url:'<?php echo U("admin/Draw/draw_edit");?>?id='+id,
            type:'post',
    ...
    function setVerify(status, id) {
        ...
        var inVain = '<a href="javascript:void(0)" onclick="setVerify(' + status + ',' + id + ')" class="btn btn-transparent btn-xs" ' +
                ...
                '<i class="fa fa-check-circle" style="color:#ccc;"></i></a>';
        $.ajax({
            url: '<?php echo U("admin/Draw/setVerify");?>?id=' + id,
            type: 'post',
