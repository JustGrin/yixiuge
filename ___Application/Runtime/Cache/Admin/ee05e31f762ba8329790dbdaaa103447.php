				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">商品品牌页面</h1><br/>
									<h3>&nbsp;&nbsp;&nbsp;品牌管理</h3>
								</div>
								<nav id="cl-effect-10" class="links cl-effect-10">
									<a data-hover="新增" href="<?php echo U('admin/goods/goods_brand_deit');?>"><span>新增</span></a>
								</nav>
							</div>
						</section>
						<!-- end: PAGE TITLE -->
...
<form role="form" class="form-inline">
	<div class="panel-body">
		<div class="form-group">
		    <input type="text" name="brand_name" id="brand_name" value="<?php echo ($_GET["brand_name"]); ?>" placeholder="品牌名称" class="form-control">
		</div>
		<div class="form-group">
			<input type="text" placeholder="品牌网址" name="site_url" id="site_url" value="<?php echo ($_GET["site_url"]); ?>" class="form-control">
		</div>
		&nbsp;
		<button class="btn btn-primary" type="submit">
			提交
						...
						<table width="90%" class="table table-hover"id="sample-table-1" align="center">
							<thead>
							<th>品牌名称</th>
							<th>品牌logo</th>
							<th>品牌描述</th>
							...
							<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
									...
									<td><img src="<?php echo U('wap/index/get_thumbs',array('auto'=>100));?>?img=<?php echo ($vo["brand_logo"]); ?>"  class="img-rounded" style="max-width:50px;max-height:50px;">
								...
								<?php if($vo["is_show"] == 1): ?><td>是</td>
									...
									<td>否</td><?php endif; ?>
									<td>
										<a href="<?php echo U('Admin/Goods/goods_brand_deit',array('brand_id'=>$vo['brand_id']));?>"
										...
										<a href="<?php echo U('Admin/Goods/goods_brand_del',array('brand_id'=>$vo['brand_id']));?>"
						...
						<div class="row">
							...
							<div class="col-md-12 pages" align="center"<?php echo ($page["page"]); ?>></div>
						</div>
						<?php if(empty($data)): ?>没有数据<?php endif; ?>
