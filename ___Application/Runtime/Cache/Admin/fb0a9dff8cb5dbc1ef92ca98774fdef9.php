						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									...
									<span class="mainDescription">员工信息</span>
								</div>
...
<div class="row">
	...
	<!--<div class="form-group">
		<label class="control-label">
		 ...
		 <?php echo ($data["my_recommend_code"]); ?>
	</div>-->
	<div class="form-group">
		<label class="control-label">
			会员类型:
		</label>
		 <?php echo ($data['vip_name']); ?>
	</div>
	<!--<div class="form-group">
		<label class="control-label">
			认证
		</label>
		 <?php echo ($data['member_status']?'已认证':'未认证'); ?>
	</div>-->
	<div class="form-group">
		<label class="control-label">
			冻结
           ...
           <?php if($data["id"] > 0): ?><input type="radio" value="1" name="member_freeze" id="id_no" <?php if($data["member_freeze"] == 1): ?>checked="checked"<?php endif; ?> >
			<label for="id_no">
				已冻结
			</label>

			<input type="radio" value="0" name="member_freeze" id="id_yes" <?php if($data["member_freeze"] == 0): ?>checked="checked"<?php endif; ?> >
			<label for="id_yes">
				未冻结
			</label>
             <?php else: ?>
             <input type="radio" value="1" name="member_freeze" id="id_no">
			<label for="id_no">
				已冻结
			</label>

			<input type="radio" value="0" name="member_freeze" id="id_yes" checked="checked"  >
			<label for="id_yes">
				未冻结
			</label><?php endif; ?>
...
<div class="form-group">
		<label class="control-label">
		 ...
		 <?php echo (date('Y-m-d H:i:s',$data["login_time"])); ?>
	</div>	
