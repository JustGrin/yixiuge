...
<head>
    ...
    <title>系统通知-<?php echo ($webseting["web_title"]); ?></title>
   ...
   <!--绑定头部-->    
    ...
    <div class="g-cn">
        ...
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                <a href="<?php echo U('wap/about/notice_detail',array('id'=>$vo['id']));?>">
                    <h3><?php echo ($vo["title"]); ?></h3>
                    <p><?php echo ($vo["add_time"]); ?></p>
                </a>
...
<script type="text/javascript">
   ...
   function get_more(){
     var p=$("input[name='p']").val();
           $.ajax({ 
            url: "<?php echo U('wap/about/notice');?>",
            type:'post',
            data: {p:p},
            dataType: 'json',
            success: function(data){
