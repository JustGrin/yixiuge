	...
	<div id="main">
        ...
        <form name=alipayment action=alipayapi.php method=post target="_blank">
            <div id="body" style="clear:left">
                <dl class="content">
                    <dt>商户订单号：</dt>
                    <dd><?php $ss=rand(100,999); ?>
                        <span class="null-star">*</span>
                        <input size="30" name="WIDout_trade_no" value="270504724415324<?php echo $ss; ?>" />
                    ...
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="WIDsubject" value="订单支付270504724415324<?php echo $ss; ?>" />
                        <span>必填
</span>
                    </dd>
                    <dt>付款金额：</dt>
                    ...
                    <dd>
                        <span class="null-star">*</span>
                        <input size="30" name="WIDshow_url"  value="http://www.nwyer.com/index.php"/>
